...
<form method="POST" action="/ShareNote/Edit">
	...
	<tr>
		<td align="center" colspan="3">${e.title}タイトル<input type="hidden" name="title" value="${e.title} }"></td>
				<td align="center"><input type="submit" name="detail" value="詳細"></td>
...
<c:forEach var="e" items="${cardList}" >
	<form method="POST" action="/ShareNote/Edit">
		...
		<tr>
			...
			<td>${e.year}年度</td>
			<td align="center" colspan="2">${e.nickname}ニックネーム</td>
			<td rowspan="2" align="center"><input type="submit" name="detail" value="詳細"></td>
		</tr>
		<tr>
			<td align="center" colspan="3">${e.title}タイトル</td>
		</tr>
		<tr>
			<td colspan="3" align="center">${e.tag}タグ</td>
			<td><input type="submit" name="download" value="ダウンロード"></td>
		</tr>
		</table>
	</form>
